            ...
            <div class="card-surface">
                <div class="p-3 border-bottom">
                    <h5 class="mb-0">
                        ...
                        Chỉnh sửa đối tác vận chuyển: {{ $doiTacVanChuyen->ten_doi_tac }}
                    </h5>
                </div>
                    ...
                    <form action="{{ route('admin.doi-tac-van-chuyen.update', $doiTacVanChuyen) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('ten_doi_tac') is-invalid @enderror"
                                    id="ten_doi_tac" name="ten_doi_tac"
                                    value="{{ old('ten_doi_tac', $doiTacVanChuyen->ten_doi_tac) }}"
                                    placeholder="VD: Giao Hàng Nhanh Express" required>
                                @error('ten_doi_tac')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('so_dien_thoai') is-invalid @enderror"
                                    ...
                                    value="{{ old('so_dien_thoai', $doiTacVanChuyen->so_dien_thoai) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email_lien_he') is-invalid @enderror"
                                id="email_lien_he" name="email_lien_he"
                                value="{{ old('email_lien_he', $doiTacVanChuyen->email_lien_he) }}"
                                placeholder="VD: contact@ghn.vn" required>
                            @error('email_lien_he')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('dia_chi_tru_so') is-invalid @enderror" id="dia_chi_tru_so"
                                ...
                                placeholder="VD: Tầng 5, Tòa nhà ABC, 123 Đường XYZ, Phường DEF, Quận GHI, TP.HCM"
                                required>{{ old('dia_chi_tru_so', $doiTacVanChuyen->dia_chi_tru_so) }}</textarea>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Thông tin:</strong> Đối tác được tạo ngày
                            {{ $doiTacVanChuyen->created_at->format('d/m/Y H:i') }}
                            @if($doiTacVanChuyen->updated_at != $doiTacVanChuyen->created_at)
                                và cập nhật lần cuối ngày {{ $doiTacVanChuyen->updated_at->format('d/m/Y H:i') }}
                            @endif
                        </div>
