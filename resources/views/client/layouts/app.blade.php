    ...
    <header class="header_section">
        <div class="container">
            <nav class="navbar navbar-expand-lg custom_nav-container">
                ...
                <div class="user_option d-flex align-items-center" style="gap: 12px; margin-left: auto;">
                    @if (!in_array(Route::currentRouteName(), ['orders.history', 'orders.show', 'reviews.create']))
                    <a href="{{ route('cart.index') }}" class="order_online" style="margin-right: 0;">
                    ...
                    @if(Auth::check())
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle user-dropdown" data-toggle="dropdown"
                                ...
                                <span class="d-none d-sm-inline">{{ Auth::user()->HoTen }}</span>
                            </a>
