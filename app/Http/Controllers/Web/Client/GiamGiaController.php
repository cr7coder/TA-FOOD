...
class GiamGiaController extends Controller
{
    ...
    {
        return [
            'MaCode'           => ['required', 'string', 'max:12', 'alpha_num', Rule::unique('giam_gia', 'MaCode')->whereNull('deleted_at')],
    ...
    private function getMessages(): array
    {
        return [
            ...
            'SoLuongToiDa.min'     => 'Tổng số lượng phát hành phải lớn hơn 0',

            // Giới hạn người dùng
            'GioiHanNguoiDung.integer' => 'Giới hạn sử dụng/1 User phải là số nguyên',
            'GioiHanNguoiDung.min'     => 'Giới hạn sử dụng/1 User phải lớn hơn 0',
    ...
    public function validateStep(Request $request)
    {
        ...
        $fieldsByStep = [
            1 => ['MaCode', 'PhanTram', 'DonHangToiThieu', 'SoLuongToiDa', 'GioiHanNguoiDung'],
