...
@section('title', 'Thêm Đối Tác Mới')
            ...
            <div class="col-lg-10"> <!-- Tăng chiều rộng lên col-lg-10 như cũ -->
                ...
                <div class="d-flex justify-content-between align-items-center mb-3"> <!-- Giảm mb -->
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="fw-bold mb-0 text-dark">Thêm Đối Tác Mới</h4>
                    </div>
                ...
                <!-- Form Card -->
                <div class="form-card">
                    <form action="{{ route('admin.doi-tac-van-chuyen.store') }}" method="POST" id="createForm" novalidate>
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nguoi_lien_he') is-invalid @enderror"
                                        id="nguoi_lien_he" name="nguoi_lien_he" value="{{ old('nguoi_lien_he') }}"
                            ...
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('phi_van_chuyen') is-invalid @enderror"
                                        id="phi_van_chuyen" name="phi_van_chuyen" value="{{ old('phi_van_chuyen', 15000) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('phi_km') is-invalid @enderror"
                                        id="phi_km" name="phi_km" value="{{ old('phi_km', 3000) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('dia_chi_tru_so') is-invalid @enderror" id="dia_chi_tru_so"
                                ...
                                placeholder="Nhập địa chỉ trụ sở chính" required>{{ old('dia_chi_tru_so') }}</textarea>
