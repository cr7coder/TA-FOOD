            ...
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 15px;">
                <div class="card-body p-4">
                    ...
                    <form id="editCategoryForm">
                        ...
                        <div class="mb-3">
                            <label for="HinhAnhFile" class="form-label text-dark fw-semibold">Chọn hình ảnh mới từ thiết bị</label>
                            <input type="file" class="form-control" id="HinhAnhFile" name="HinhAnhFile" accept="image/*">
                            <div class="form-text">Hỗ trợ JPG, JPEG, PNG, GIF (Kích thước tối đa: 2MB). Để trống nếu giữ nguyên ảnh cũ.</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Được cập nhật tự động khi tải tệp lên hoặc có thể chỉnh sửa link URL tùy chọn.</div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-select-lg" id="TrangThai" name="TrangThai" required>
                                <option value="Hoạt động">Hoạt động (Hiển thị rộng rãi)</option>
